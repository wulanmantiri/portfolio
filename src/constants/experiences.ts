export const EXPERIENCES_LIST = [
  ...
  },
  {
    ...
    descriptions: [
      ...
      `I also ##improved user traffic## by handling SEO from the backend side, creating personality
      assessment endpoints, and developing a chat with read and online feature, which doubled
      the number of registered users to 2000+ users.`,
    ],
  },
  {
    title: 'Under Secretary General of Substance',
  ...
  {
    title: 'Staff of Academics and Leadership Department',
  ...
  {
    title: 'Staff of Training and Development',
